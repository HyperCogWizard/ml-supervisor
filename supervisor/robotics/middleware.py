...
from .hypergraph import HypergraphEngine, MiddlewareInterface, TensorDimensionSpec
...
class MiddlewareComponent(ABC):
    ...
    def __init__(self, component_id: str, name: str, component_type: str):
        ...
        self.hypergraph_node_id: str | None = None
...
class ComponentRegistry:
    ...
    def get_component(self, component_id: str) -> MiddlewareComponent | None:
